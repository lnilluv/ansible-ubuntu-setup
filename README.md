...
`main-playbook.yml` reuses the Tailnet IPv4 discovered during bootstrap and uses that
host for the lockdown phase, avoiding endpoint-discovery stalls between phases.
